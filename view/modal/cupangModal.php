    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header" style="background-color: rgba(0, 120, 255, 1); color:white;">
            <h5 class="modal-title">Tambah Data Cupang</h5>
        ...
        <div class="modal-body">
            <div class="form-group">
                <label for="nama_cupang_tambah" class="control-label col-lg-2">Nama</label>
                <input type="text" name="nama_cupang_tambah" class="form-control" id="nama_cupang_tambah" required autocomplete="off">
                <span class="help-block" id="nama_cupang_tambah_error"></span>
            </div>
